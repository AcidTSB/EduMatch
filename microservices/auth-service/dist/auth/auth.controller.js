...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Firebase login' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Firebase login successful' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Invalid Firebase token' }),
    (0, common_1.Post)('firebase-login'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [login_dto_1.FirebaseLoginDto]),
    __metadata("design:returntype", Promise)
