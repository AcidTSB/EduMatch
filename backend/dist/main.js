...
const scholarships_module_1 = __webpack_require__(/*! ./modules/scholarships/scholarships.module */ "./src/modules/scholarships/scholarships.module.ts");
const applications_module_1 = __webpack_require__(/*! ./modules/applications/applications.module */ "./src/modules/applications/applications.module.ts");
const matching_module_1 = __webpack_require__(/*! ./modules/matching/matching.module */ "./src/modules/matching/matching.module.ts");
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_c = typeof login_dto_1.RegisterDto !== "undefined" && login_dto_1.RegisterDto) === "function" ? _c : Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_d = typeof login_dto_1.FirebaseLoginDto !== "undefined" && login_dto_1.FirebaseLoginDto) === "function" ? _d : Object]),
    __metadata("design:returntype", Promise)
...
const firebase_strategy_1 = __webpack_require__(/*! ./strategies/firebase.strategy */ "./src/modules/auth/strategies/firebase.strategy.ts");
...
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [auth_service_1.AuthService, jwt_strategy_1.JwtStrategy, local_strategy_1.LocalStrategy, firebase_strategy_1.FirebaseStrategy],
...
const passport_1 = __webpack_require__(/*! @nestjs/passport */ "@nestjs/passport");
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const passport_custom_1 = __webpack_require__(/*! passport-custom */ "passport-custom");
const users_service_1 = __webpack_require__(/*! ../../users/users.service */ "./src/modules/users/users.service.ts");
...
let ProfilesController = class ProfilesController {
    ...
    async searchProfiles(searchQuery, role) {
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Search profiles' }),
    (0, common_1.Get)(),
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const profiles_controller_1 = __webpack_require__(/*! ./profiles.controller */ "./src/modules/profiles/profiles.controller.ts");
const profiles_service_1 = __webpack_require__(/*! ./profiles.service */ "./src/modules/profiles/profiles.service.ts");
...
/***/ "./src/modules/scholarships/scholarships.module.ts":
/*!*********************************************************!*\
  !*** ./src/modules/scholarships/scholarships.module.ts ***!
  \*********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
async function bootstrap() {
    ...
    const config = new swagger_1.DocumentBuilder()
        ...
        .setDescription('Smart platform connecting students with research opportunities and scholarships')
        .setVersion('1.0')
        .addBearerAuth()
        .build();
    ...
    console.log(`🚀 EduMatch Backend is running on: http://localhost:${port}`);
