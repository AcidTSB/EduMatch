...
export default function AdminDashboard() {
  ...
  const handleGenerateReport = () => {
    ...
    const reportData = {
      ...
      pendingApplications,
      totalFunding,
      students: mockUsers.filter(u => u.role === UserRole.USER).length,
      providers: mockUsers.filter(u => u.role === UserRole.EMPLOYER).length,
  ...
  const recentUsers = mockUsers
    ...
    .map(user => {
      ...
      return {
        ...
        email: user.email,
        role: user.role === UserRole.USER ? 'Student' : 'Provider',
